<template>
  ...
  <div
    ...
    <div class="flex flex-col items-center">
      <!-- 博主头像 -->
      <img class="mb-4 w-[95px] h-[95px] mb-3 rounded-full shadow"
           :src="blogSettingsStore.blogSettings.avatar"
           alt="Bonnie image"/>
      <!-- 博主昵称 -->
      <h5 class="mb-2 text-xl font-medium text-gray-900 dark:text-white">朱少康</h5>
      <!-- 介绍语 -->
      ...
      <div class="flex justify-center gap-2">
        ...
        <svg v-if="blogSettingsStore.blogSettings.githubHomepage" t="1698029949662"
             ...
             data-tooltip-placement="bottom" class="hover:scale-110 icon mt-5 w-7 h-7 cursor-pointer" viewBox="0 0 1024 1024" version="1.1"
        ...
        <svg v-if="blogSettingsStore.blogSettings.csdnHomepage" t="1698031311586"
             ...
             class="hover:scale-110 icon mt-5 w-7 h-7 cursor-pointer" viewBox="0 0 1024 1024" version="1.1"
...
import {getStatisticsInfo} from "@/api/frontend/statistics.js";
