<template>
    ...
    <div class="p-5 mb-4 border border-gray-200 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700">
      <h1 class="flex items-center text-lg font-semibold text-gray-900 dark:text-white">
        <!-- 文件夹图标 -->
        <svg t="1698998570037" class="icon inline w-5 h-5 mr-2" viewBox="0 0 1024 1024"
      ...
      <div v-else class="flex items-center justify-center flex-col">
        <svg height="300" node-id="1" sillyvg="true" template-height="600" template-width="600" version="1.1"
          ...
          <path d="M 181.00 295.00 L 311.00 295.00 L 311.00 439.00 L 181.00 439.00 Z" fill="#a2abb9" fill-rule="evenodd"
                group-id="3" id="矩形" node-id="32" stroke="none" target-height="144" target-width="130" target-x="181"
                target-y="295"/>
          <path d="M 178.00 309.00 L 314.00 309.00 L 314.00 436.00 L 178.00 436.00 Z" fill="#ffffff" fill-rule="evenodd"
                group-id="3" id="矩形" node-id="33" stroke="none" target-height="127" target-width="136" target-x="178"
                target-y="309"/>
          <path d="M 177.00 318.00 L 318.00 318.00 L 318.00 435.00 L 177.00 435.00 Z" fill="#c8cede" fill-rule="evenodd"
                group-id="3" id="矩形" node-id="34" stroke="none" target-height="117" target-width="141" target-x="177"
                target-y="318"/>
